 ...
 */
public class GameSuperFragment_copy extends BaseFragment_Refresh_2 implements View.OnClickListener,
	...
	public static GameSuperFragment_copy newInstance() {
		return new GameSuperFragment_copy();
	}
