...
import com.oplay.giftassistant.ui.widget.slideexpandlelistview.ActionSlideExpandableListView;
import com.oplay.giftassistant.ui.widget.stickylistheaders.AdapterWrapper;
import com.oplay.giftassistant.ui.widget.stickylistheaders.SectionIndexerAdapterWrapper;
import com.oplay.giftassistant.ui.widget.stickylistheaders.StickyListHeadersAdapter;
import com.oplay.giftassistant.ui.widget.stickylistheaders.WrapperView;
 ...
 */
public class StickyListHeadersListViewExpandable extends ActionSlideExpandableListView {
	...
	private AdapterWrapper.OnHeaderClickListener mAdapterHeaderClickListener = new AdapterWrapper
		...
		public void onHeaderClick(View header, int itemPosition, long headerId) {
			if (mOnHeaderClickListener != null) {
				mOnHeaderClickListener.onHeaderClick(
						StickyListHeadersListViewExpandable.this, header, itemPosition,
						headerId, false);
			}
		}
	};
	...
	public StickyListHeadersListViewExpandable(Context context) {
		this(context, null);
	}

	public StickyListHeadersListViewExpandable(Context context, AttributeSet attrs) {
		...
		if (childCount != 0) {
			...
			for (int i = 0; i < childCount; i++) {
				...
				if (viewToWatch == null
						...
						|| ((childIsFooter || ((child instanceof WrapperView) &&
			...
			if (child instanceof WrapperView) {
				...
				if (wrapperViewChild.hasHeader()) {
					...
					if (wrapperViewChild.getTop() < top) {
						childHeader.setVisibility(INVISIBLE);
					} else {
						childHeader.setVisibility(VISIBLE);
					}
				}
			}
		}
	...
	public interface OnHeaderClickListener {
		public void onHeaderClick(StickyListHeadersListViewExpandable l, View header,
