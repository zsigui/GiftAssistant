package com.oplay.giftassistant.handler.share;
...
/*
	...
	*//**
	 ...
	 *//*
	public void shareByWeixin(ShareContent shareWay, int shareType){
		switch (shareWay.getShareWay()) {
			case WEIXIN_SHARE_WAY_TEXT:
				shareText(shareType, shareWay);
				break;
			case WEIXIN_SHARE_WAY_PIC:
				sharePicture(shareType, shareWay);
				break;
			case WEIXIN_SHARE_WAY_WEBPAGE:
				shareWebPage(shareType, shareWay);
				break;
		}
	}
