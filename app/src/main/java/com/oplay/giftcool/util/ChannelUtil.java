...
public class ChannelUtil {
    ...
    public static int getChannelId(Context context) {
        ...
        if (chnInt != 0) {
            AppDebugConfig.d(AppDebugConfig.TAG_CHANNEL, "GET CHANNEL FROM SP : " + chnInt);
            return chnInt;
        }
        ...
        try {
            ...
            while (zipEntries.hasMoreElements()) {
                ...
                if (entryName.endsWith(Global.CHANNEL_FILE_NAME_SUFFIX)) {
                    AppDebugConfig.d(AppDebugConfig.TAG_CHANNEL, "CHANNEL_FILE_ENTRY:" + entryName);
            ...
            if (!TextUtils.isEmpty(channelFileName)) {
                ...
                AppDebugConfig.d(AppDebugConfig.TAG_CHANNEL, "NAME:" + channelFileName + " MISC:"
