    ...
    public static String getAPN(Context context) {
        ...
        if (!Util_System_Permission.isWith_INTERNET_Permission(context)) {
            AppDebugConfig.d(AppDebugConfig.TAG_UTIL,
                    "Please Add \"android.permission.INTERNET\" To AndroidManifest.xml");
        }
        ...
        if (!Util_System_Permission.isWith_ACCESS_NETWORK_STATE_Permission(context)) {
            AppDebugConfig.d(AppDebugConfig.TAG_UTIL,
                    "Please Add \"android.permission.ACCESS_NETWORK_STATE\" To AndroidManifest.xml");
        }
        ...
        if (!Util_System_Permission.isWith_ACCESS_WIFI_STATE_Permission(context)) {
            AppDebugConfig.d(AppDebugConfig.TAG_UTIL,
                    "Please Add \"android.permission.ACCESS_WIFI_STATE\" To AndroidManifest.xml");
        }
        ...
        try {
            ...
            if (activeNetworkInfo != null) {
                ...
                if (!activeNetworkInfo.isAvailable()) {
                    AppDebugConfig.d(AppDebugConfig.TAG_UTIL, "当前网络不可用");
                    return "UNKNOW_APN";
                }
                // 网络可用
                else {
                    ...
                    switch (activeNetworkInfo.getType()) {
                        case ConnectivityManager.TYPE_WIFI: // wifi网络
                            AppDebugConfig.d(AppDebugConfig.TAG_UTIL, "当前网络为wifi网络");
                            return "WIFI";
                        case ConnectivityManager.TYPE_MOBILE: // 手机网络
                            AppDebugConfig.d(AppDebugConfig.TAG_UTIL, "当前网络为手机网络");
