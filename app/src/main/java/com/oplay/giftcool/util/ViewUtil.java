...
public class ViewUtil {
     ...
     * 设置礼包'价值:￥5.00'的显示方式
     */
    public static void siteValueUI(DeletedTextView tv, int value, boolean delete) {
        ...
        if (delete) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                tv.setPaint(context.getResources().getColor(R.color.co_btn_grey_pressed), 3);
            } else {
                tv.setPaint(context.getResources().getColor(R.color.co_btn_grey_pressed, null), 3);
            }
        }
