	...
	public static void siteValueUI(TextView tv, int value, boolean delete) {
		...
		if (delete && tv instanceof DeletedTextView) {
			if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
				((DeletedTextView)tv).setPaint(context.getResources().getColor(R.color.co_btn_grey_pressed), 3);
			} else {
				((DeletedTextView)tv).setPaint(context.getResources().getColor(R.color.co_btn_grey_pressed, null), 3);
			}
		}
	}
