 ...
 * @date 2015/12/13
 */
public class GiftFragment_old extends BaseFragment_Refresh implements View.OnClickListener, OnItemClickListener,
	...
	public static GiftFragment_old newInstance() {
		GiftFragment_old fragment = new GiftFragment_old();
	...
	protected void processLogic(Bundle savedInstanceState) {
		...
		mLimitAdapter = new IndexGiftLimitAdapter(getContext());
...
//		AssistantApp.getRefWatcher(getActivity()).watch(mBanner);
	...
	private static class UpdateHandler extends Handler {
		...
		private WeakReference<GiftFragment_old> mFragWeakLink;

		public UpdateHandler(GiftFragment_old frag) {
			mFragWeakLink = new WeakReference<GiftFragment_old>(frag);
		}
		...
		public void handleMessage(Message msg) {
			...
			GiftFragment_old fragment = mFragWeakLink.get();
