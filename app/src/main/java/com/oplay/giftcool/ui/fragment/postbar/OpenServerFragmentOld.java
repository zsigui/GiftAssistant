...
// */
//public class OpenServerFragmentOld extends BaseFragment_Refresh<ServerInfo> implements CallbackListener<Boolean> {
//
//
...
//    }
//
//    public static OpenServerFragmentOld newInstance(int type) {
//        OpenServerFragmentOld fragment = new OpenServerFragmentOld();
...
//            ReqServerInfo serverInfo = new ReqServerInfo();
//            serverInfo.isFocus = 1;
//            serverInfo.page = mFocusLoadIndex + 1;
//            serverInfo.startDate = mSortedTags.get(INDEX_TODAY).tag;
//            mFocusReq = new JsonReqBase<>(serverInfo);
//        } else {
//            mFocusLoadIndex = mFocusLoadIndex + 1;
//            mFocusReq.data.page = mFocusLoadIndex;
//        }
//
//        mCall = Global.getNetEngine().obtainServerInfo(mUrl, mFocusReq);
//        mCall.enqueue(new Callback<JsonRespBase<OneTypeDataList<ServerInfo>>>() {
...
//                reqBase.data.page = data.offsetRefresh - 1;
//                reqBase.data.startDate = data.tag;
//                if (reqBase.data.page == 0) {
//                    mHasData = false;
//                }
//
...
//                JsonReqBase<ReqServerInfo> reqBase = new JsonReqBase<>(serverInfo);
//                reqBase.data.isFocus = focus;
//                reqBase.data.page = data.offsetLoad + 1;
//                reqBase.data.startDate = data.tag;
//
//                mCall = Global.getNetEngine().obtainServerInfo(mUrl, reqBase);
//                mCall.enqueue(new Callback<JsonRespBase<OneTypeDataList<ServerInfo>>>() {
