...
public class GiftConsumeDialog extends BaseFragment_Dialog implements ObserverManager.UserUpdateListener {
    ...
    private final String BEAN_SCORE_BOTH_BASE = "抢该礼包将消耗：<img src='ic_score'/> "
            + "<font color='#f85454'>%d</font> "
            + "或 <img src='ic_bean'/> <font color='#f85454'>%d</font>，";
    private final String BEAN_SCORE_BOTH_NOT_ENOUGH = BEAN_SCORE_BOTH_BASE + "余额不足。";
    private final String BEAN_SCORE_BOTH_ENOUGH = BEAN_SCORE_BOTH_BASE + "确认抢号吗?";
    private final String SCORE_BASE = "抢该礼包将消耗：<img src='ic_score'/> <font color='#f85454'>%d</font>，";
    private final String SCORE_NOT_ENOUGH = SCORE_BASE + "余额不足。";
    private final String SCORE_ENOUGH = SCORE_BASE + "确认抢号吗?";
    private final String BEAN_BASE = "抢该礼包将消耗：<img src='ic_bean'/> <font color='#f85454'>%d</font>，";
    private final String BEAN_NOT_ENOUGH = BEAN_BASE + "余额不足。";
    private final String BEAN_ENOUGH = BEAN_BASE + "确认抢号吗?";
    private final String SCORE_PAY_NOT_ENOUGH = "金币支付(余额不足)";
    private final String BEAN_PAY_NOT_ENOUGH = "偶玩豆支付(余额不足)";
    ...
    protected void initView() {
        setContentView(R.layout.dialog_gift_consume_new);
    ...
    private void resetUI() {
        ...
        if (mConsumeType == GiftTypeUtil.PAY_TYPE_BOTH) {
            ...
            if (mBeanConsume <= hasBean) {
                ...
                ctvCheckBean.setText(BEAN_PAY_NOT_ENOUGH);
            }
            if (mScoreConsume <= hasScore) {
                ...
                ctvCheckScore.setText(SCORE_PAY_NOT_ENOUGH);
            }
            ...
            tvPayBean.setText(String.valueOf(mBeanConsume));
            tvPayScore.setText(String.valueOf(mScoreConsume));
