...
public class GiftAdapter extends RecyclerView.Adapter implements com.bigkoo.convenientbanner.listener.OnItemClickListener, View.OnClickListener {
        ...
        switch (type) {
            ...
            default:
                ...
                if (type == GiftTypeUtil.TYPE_NORMAL_SEIZE) {
                    ...
                    viewHolder.tvPercent.setText(String.format("剩余%d%%", percent));
    ...
    private void setCommonField(final ItemHolder itemHolder, final IndexGiftNew gift) {
        ...
        itemHolder.tvTitle.setText(String.format("[%s]%s", gift.gameName, gift.name));
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.rl_recommend
            ...
            if (pos == null || pos < 5 || pos >= mData.news.size()) {
                return;
            }
