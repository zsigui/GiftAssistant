 ...
 */
public class GiftAdapterNew extends BaseRVAdapter<Object> implements View.OnClickListener {
    ...
    public GiftAdapterNew(FragmentActivity context) {
        super(context);
        ...
        if (type != null) {
            ...
            switch (v.getId()) {
                ...
                case R.id.rl_like:
                    ...
                    IntentUtil.jumpGameDetail(mContext, o.id);
                    break;
