 ...
 */
public class GameNoticeAdapter extends BaseRVAdapter_Download<IndexGameNew> implements FooterListener {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (o.playCount < 10000) {
            viewHolder.tvPlay.setText(Html.fromHtml(String.format(Locale.CHINA, "<font color='#ffaa17'>%d人</font>在玩",
                    o.playCount)));
        } else {
            viewHolder.tvPlay.setText(Html.fromHtml(String.format(Locale.CHINA, "<font color='#ffaa17'>%.1f万人</font>在玩",
