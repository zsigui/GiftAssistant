 ...
 */
public class RoundDividerItemDecoration extends DividerItemDecoration {


	public RoundDividerItemDecoration(Context context, int orientation) {
		super(context, orientation);
	}

	public RoundDividerItemDecoration(Context context, int orientation, int dividerColor, int dividerSize) {
