    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (o.playCount > 10000) {
            holder.tvContent.setText(Html.fromHtml(
                    String.format(Locale.CHINA, "<font color='#ffaa17'>%.1f万人</font>在玩",
                            (float) o.playCount / 10000)));
        } else {
            holder.tvContent.setText(Html.fromHtml(
                    String.format(Locale.CHINA, "<font color='#ffaa17'>%d人</font>在玩",
                            o.playCount)));
        }
        if (o.totalCount > 0) {
            holder.ivGift.setVisibility(View.VISIBLE);
            holder.tvGift.setText(Html.fromHtml(String.format(Locale.CHINA,
                    "<font color='#ffaa17'>%s</font> 等共<font color='#ffaa17'>%d</font>款礼包或首充券",
                    o.giftName, o.totalCount)));
        } else {
            holder.tvGift.setText("暂时还木有礼包或首充券");
