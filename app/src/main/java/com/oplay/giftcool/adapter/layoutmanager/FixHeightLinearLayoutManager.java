 ...
 */
public class FixHeightLinearLayoutManager extends LinearLayoutManager {
	public FixHeightLinearLayoutManager(Context context) {
		super(context);
	}

	public FixHeightLinearLayoutManager(Context context, int orientation, boolean reverseLayout) {
