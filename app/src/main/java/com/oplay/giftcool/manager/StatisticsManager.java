...
public class StatisticsManager {
    ...
    public void onResume(Activity context) {
        if (AppDebugConfig.IS_STATISTICS_SHOW) {
            judgeInit(context);
            if (AppDebugConfig.IS_DEBUG) {
                KLog.d(AppDebugConfig.TAG_WARN, "statistics onResume");
            }
    ...
    public void onPause(Activity context) {
        if (AppDebugConfig.IS_STATISTICS_SHOW) {
            judgeInit(context);
            if (AppDebugConfig.IS_DEBUG) {
                KLog.d(AppDebugConfig.TAG_WARN, "statistics onPause");
            }
    ...
    public void onPageStart(Context context, String name) {
        if (AppDebugConfig.IS_STATISTICS_SHOW) {
            if (!TextUtils.isEmpty(name)) {
                judgeInit(context);
                if (AppDebugConfig.IS_DEBUG) {
                    KLog.d(AppDebugConfig.TAG_WARN, "statistics onPageStart");
                }
    ...
    public void onPageEnd(Context context, String name) {
        if (AppDebugConfig.IS_STATISTICS_SHOW) {
            if (!TextUtils.isEmpty(name)) {
                judgeInit(context);
                if (AppDebugConfig.IS_DEBUG) {
                    KLog.d(AppDebugConfig.TAG_WARN, "statistics onPageEnd");
                }
...
//			KLog.d(AppDebugConfig.TAG_WARN, "mIsinit = " + mIsInit);
    ...
    public void exit(Context context) {
        KLog.d(AppDebugConfig.TAG_WARN, "statics exit init = " + mIsInit);
        if (AppDebugConfig.IS_STATISTICS_SHOW) {
            if (mIsInit) {
    ...
    public static String getDeviceInfo(Context context) {
        try {
            ...
            KLog.d(AppDebugConfig.TAG_WARN, "mac = " + mac);
            json.put("mac", mac);
