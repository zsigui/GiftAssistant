...
public class ConstString {
    ...
    public static final String TOAST_SHARE_ERROR = "分享内容出错。";
    // 分享成功
    ...
    public static final String TOAST_GET_FOCUS_ACTIVITY_FAILED =
            "呜，网络有点挤，请稍后重试！(" + CODE_GET_FOCUS_ACTIVITY_FAILED + ")";
    // 点击qq群直接调起qq失败
