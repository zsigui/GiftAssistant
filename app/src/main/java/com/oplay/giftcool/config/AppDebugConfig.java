...
public class AppDebugConfig {
     ...
     */
    public static final boolean IS_DEBUG = AppConfig.TEST_MODE;
    public static final boolean IS_FRAG_DEBUG = AppConfig.TEST_MODE;
	public static final boolean IS_PERM_DEBUG = AppConfig.TEST_MODE;
