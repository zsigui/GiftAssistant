...
public interface NetEngine {
     ...
     */
    @POST(NetUrl.GIFT_GET_NEW_BY_PAGE)
     ...
     */
    @POST(NetUrl.GIFT_GET_NEW_BY_PAGE)
    Call<JsonRespBase<OneTypeDataList<IndexGiftNew>>> obtainGiftNewByPage(@Body JsonReqBase<ReqPageData> reqData);
...
//	Call<JsonRespBase<HashMap<String, IndexGiftNew>>> updateGiftLimit(@Body JsonReqBase<ReqRefreshGift> reqData);
    ...
    Call<JsonRespBase<LimitGiftListData<TimeData<IndexGiftNew>>>> obtainGiftLimitByPage(@Body
                                                                                        JsonReqBase<ReqPageData>
                                                                                                reqData);
     ...
     */
    @POST
    Call<JsonRespBase<OneTypeDataList<IndexPostNew>>> obtainPostList(@Url String url, @Body JsonReqBase<ReqIndexPost>
            reqData);
