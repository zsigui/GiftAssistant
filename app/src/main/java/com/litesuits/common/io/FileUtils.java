...
public class FileUtils {
     ...
     * false otherwise
     * @throws java.io.IOException in case of an I/O error
     * @see com.litesuits.common.io.IOUtils#contentEqualsIgnoreEOL(java.io.Reader, java.io.Reader)
     * @since 2.2
     */
     ...
     * @throws NullPointerException if source or destination is {@code null}
     * @throws com.litesuits.common.io.FileUtils.FileExistsException  if the destination directory exists
     * @throws java.io.IOException  if source or destination is invalid
     ...
     * @throws NullPointerException if source or destination is {@code null}
     * @throws com.litesuits.common.io.FileUtils.FileExistsException  if the directory exists in the destination directory
     * @throws java.io.IOException  if source or destination is invalid
     * @throws java.io.IOException  if an IO error occurs moving the file
     * @since 1.4
     */
     ...
     * @throws NullPointerException if source or destination is {@code null}
     * @throws com.litesuits.common.io.FileUtils.FileExistsException  if the destination file exists
     * @throws java.io.IOException  if source or destination is invalid
     * @throws java.io.IOException  if an IO error occurs moving the file
     * @since 1.4
     */
