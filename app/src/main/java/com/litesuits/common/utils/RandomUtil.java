...
public class RandomUtil {
     ...
     * @param length
     * @return
     * @see com.litesuits.common.utils.RandomUtil#getRandom(String source, int length)
     */
     ...
     * <li>else see {@link com.litesuits.common.utils.RandomUtil#getRandom(char[] sourceChar, int length)}</li>
     * </ul>
     */
