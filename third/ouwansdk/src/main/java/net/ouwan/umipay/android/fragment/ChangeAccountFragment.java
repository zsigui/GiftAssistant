...
public class ChangeAccountFragment extends BaseFragment {
    ...
    private void setUserName(TextView tv) {
        ...
        UmipayCommonAccount account = UmipayCommonAccountCacheManager.getInstance(getActivity())
                .getCommonAccountByPackageName(getActivity().getPackageName(), UmipayCommonAccountCacheManager
				        .COMMON_ACCOUNT_TO_CHANGE);
        if (account != null) {
