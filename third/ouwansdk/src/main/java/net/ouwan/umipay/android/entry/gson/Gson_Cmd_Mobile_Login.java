 ...
 *         description
 */
public class Gson_Cmd_Mobile_Login extends Gson_Base<Gson_Cmd_Mobile_Login.Cmd_Mobile_Login_Data> {

	public Gson_Cmd_Mobile_Login(Context context, int code, String message, Cmd_Mobile_Login_Data cmd_login_data) {
	...
	public class Cmd_Mobile_Login_Data {
		@SerializedName("uid")
		private int uid;
