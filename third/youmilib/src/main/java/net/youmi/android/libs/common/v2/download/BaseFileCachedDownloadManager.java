 ...
 */
public abstract class BaseFileCachedDownloadManager extends AbsCachedDownloadManager {

	protected BaseFileCachedDownloadManager(Context context) throws NullPointerException, IOException {
		super(context);
	}
	...
	public AbsDownloadNotifier newDownloadNotifier() {
		return new DefaultDownloadNotifier();
	}
	...
	public AbsCacheExecutorService newAbsCacheExecutorService() {
		return new DefaultDownloadCacheExecutorService("FileDownload-Cache");
	}
